...
import { convertCustomVariablesToNativeMap, transformOptionsForNative } from "./customVariables";
export { PAYWALL_RESULT } from "@revenuecat/purchases-typescript-internal";
export { CustomVariableValue } from "./customVariables";
 ...
 * @enum {string}
 */
export let PURCHASE_LOGIC_RESULT = /*#__PURE__*/function (PURCHASE_LOGIC_RESULT) {
...
function throwIfNativeModulesNotAvailable() {
...
const NativePaywall = !usingPreviewAPIMode && UIManager.getViewManagerConfig('Paywall') != null ? requireNativeComponent('Paywall') : null;
const NativePaywallFooter = !usingPreviewAPIMode && UIManager.getViewManagerConfig('Paywall') != null ? requireNativeComponent('RCPaywallFooterView') : null;
...
const InternalPaywall = ({
  ...
  if (usingPreviewAPIMode) {
    return /*#__PURE__*/React.createElement(PreviewPaywall, {
    ...
    return /*#__PURE__*/React.createElement(NativePaywall, {
      style: style,
      children: children,
      options: {
        ...transformedOptions,
      ...
      onUrlOpened: event => onUrlOpened && onUrlOpened(event.nativeEvent.url)
    });
  }
  throw new Error(NATIVE_MODULE_NOT_FOUND_ERROR);
};
const InternalPaywallFooterView = ({
  ...
  if (usingPreviewAPIMode) {
    ...
    // Transform options to native format (CustomVariables -> string map)
    const transformedOptions = transformOptionsForNative(options);
    return /*#__PURE__*/React.createElement(NativePaywallFooter, {
      style: style,
      children: children,
...
const InternalCustomerCenterView = !usingPreviewAPIMode && UIManager.getViewManagerConfig('CustomerCenterView') != null ? requireNativeComponent('CustomerCenterView') : null;
...
export default class RevenueCatUI {
  ...
  static Paywall = ({
    ...
    return /*#__PURE__*/React.createElement(InternalPaywall, {
      options: options,
      children: children,
  ...
  static CustomerCenterView = ({
    ...
    if (usingPreviewAPIMode) {
      return /*#__PURE__*/React.createElement(PreviewCustomerCenter, {
        onDismiss: () => onDismiss && onDismiss(),
        style: [{
          flex: 1
        }, style]
    ...
    return /*#__PURE__*/React.createElement(InternalCustomerCenterView, {
      ...
      onPromotionalOfferSucceeded: onPromotionalOfferSucceeded ? event => onPromotionalOfferSucceeded(event.nativeEvent) : undefined,
  ...
  static presentCustomerCenter(params) {
    ...
    if (params !== null && params !== void 0 && params.callbacks) {
      ...
      if (callbacks.onPromotionalOfferSucceeded) {
        const subscription = customerCenterEventEmitter === null || customerCenterEventEmitter === void 0 ? void 0 : customerCenterEventEmitter.addListener('onPromotionalOfferSucceeded', event => callbacks.onPromotionalOfferSucceeded && callbacks.onPromotionalOfferSucceeded(event));
        if (subscription) {
          subscriptions.push(subscription);
        }
      }
