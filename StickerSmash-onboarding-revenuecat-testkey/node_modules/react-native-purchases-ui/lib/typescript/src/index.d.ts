...
import { type CustomVariables } from "./customVariables";
...
export default class RevenueCatUI {
     ...
     */
    static presentPaywall({ offering, displayCloseButton, fontFamily, customVariables, }?: PresentPaywallParams): Promise<PAYWALL_RESULT>;
    /**
     ...
     * @returns {Promise<PAYWALL_RESULT>} A promise that resolves with the result of the paywall presentation.
     */
    static presentPaywallIfNeeded({ requiredEntitlementIdentifier, offering, displayCloseButton, fontFamily, customVariables, }: PresentPaywallIfNeededParams): Promise<PAYWALL_RESULT>;
