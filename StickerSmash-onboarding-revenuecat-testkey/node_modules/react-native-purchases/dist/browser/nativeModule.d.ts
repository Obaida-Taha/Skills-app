...
export declare const browserNativeModuleRNPurchases: {
    ...
    setOnesignalUserID: (_onesignalUserID: string) => Promise<void>;
    ...
    generateRewardVerificationToken: (_impressionId: string) => Promise<void>;
    pollRewardVerification: (_clientTransactionId: string) => Promise<void>;
};
