...
var Purchases = /** @class */ (function () {
     ...
     */
    Purchases.setOnesignalUserID = function (onesignalUserID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, throwIfNotConfigured()];
     ...
     * @beta
     */
    Purchases.generateRewardVerificationToken = function (impressionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, throwIfNotConfigured()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, RNPurchases.generateRewardVerificationToken(impressionId)];
                }
            });
        });
    };
     ...
     * @beta
     */
    Purchases.pollRewardVerification = function (clientTransactionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, throwIfNotConfigured()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, RNPurchases.pollRewardVerification(clientTransactionId)];
                }
            });
        });
    };
