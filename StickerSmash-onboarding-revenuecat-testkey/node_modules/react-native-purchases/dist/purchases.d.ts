 ...
 * @beta
 */
export type VerifiedReward = VerifiedVirtualCurrencyReward | VerifiedEntitlementReward | VerifiedNoReward | VerifiedUnsupportedReward;
/** @beta */
...
export default class Purchases {
     ...
     */
    static setOnesignalUserID(onesignalUserID: string | null): Promise<void>;
    /**
     ...
     * @beta
     */
    static generateRewardVerificationToken(impressionId: string): Promise<RewardVerificationToken>;
    /**
     ...
     * @beta
     */
    static pollRewardVerification(clientTransactionId: string): Promise<RewardVerificationResult>;
